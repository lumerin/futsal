...
if (isset($_POST['simpan'])) {
  $field = array('nama' => $_POST['nama'], 'jk' => $_POST['jk'], 'alamat' => $_POST['alamat'], 'noktp' => $_POST['noktp'], 'nohp' => $_POST['nohp']);
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Kelola Data <small class="text-secondary" style="font-size:18px">pelanggan</small> </h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="card card-primary card-outline">
    ...
    <div class="card-body">
      <button type="button" class="btn btn-success btn-flat" name="button" style="margin-bottom: 10px" data-toggle="modal" data-target="#tambahpelanggan"><span class="fa fa-plus"></span> Data</button><br>

      <table  id="pelanggan" style="width:100%" class="table table-bordered table-striped">
        <thead>
          <tr>
            <th>Id</th>
            <th>Nama</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <form method="post">
                <a href="?page=pelanggan&hapus&id=<?php echo $isi[0] ?>" class="btn btn-danger" onclick="return confirm('<?php echo "Yakin Akan Menghapus data : ".$isi[0]." dengan nama ".$isi[1]." ?" ?> ')"><i class="fa fa-trash"></i></a> ||

                <a href="?page=pelanggan&edit&id=<?php echo $isi[0] ?>" class="btn btn-info btn-info"  data-toggle="modal" data-target="#editpelanggan<?php echo $isi[0]?>"><i class="fa fa-edit"></i></button>
              </form>
            </td>
          </tr>
          ...
          <div id="editpelanggan<?php echo $isi[0]?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="index.php?page=pelanggan&ubah&id=<?php echo @$isi[0] ?>" method="post">
                    <div class="form-group row">
                      <label class="col-md-2 form-label">pelanggan</label>
                      <div class="col-md-10">
                        <input type="text" class="form-control" placeholder="Masukan nama pelanggan" name="nama" value="<?php echo $isi[1] ?>">
                      </div>
                    </div>
  ...
  <!-- modal tambah data-->
  <div id="tambahpelanggan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Input Data pelanggan</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          <form method="post">
            <div class="form-group row">
              <label class="col-md-2 form-label">pelanggan</label>
              <div class="col-md-10">
                <input type="text" class="form-control" placeholder="Masukan nama pelanggan" name="nama" value="">
              </div>
            </div>
