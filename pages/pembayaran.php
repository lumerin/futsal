  ...
  if (isset($_POST['simpan'])) {
    $field = array('id' => $kode, 'id_pelanggan' => $_POST['id_pelanggan'], 'bayar' => $_POST['bayar'], 'tgl_bayar' => date("Y-m-d"));
...
<div class="content-wrapper">
  ...
  <!-- /.content-header -->
    ...
    <div class="card card-primary card-outline">
      ...
      <div class="card-body">
        <a href="index.php?page=inputPembayaran" class="btn btn-success btn-flat" style="margin-bottom: 10px"><span class="fa fa-plus"></span> Data</a>
        ...
        <table  id="booking" style="width:100%" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
             ...
             ?>
            <tr>
              <td align="left"><?php echo $isi[0]; ?></td>
              <td align="left"><?php echo $isi[1]; ?></td>
              <td align="center"><?php echo $isi[2]; ?></td>
              <td align="center"><?php echo $isi[3]; ?></td>
              ...
              <td align="left"><?php echo $isi[8]; ?></td>
              <form method="post">
              <td>
                  <a href="?page=pembayaran&hapus&id=<?php echo $isi[0] ?>" class="btn btn-danger" onclick="return confirm('<?php echo "Yakin Akan Menghapus data : ".$isi[0]." dengan nama ".$isi[4]." ?" ?> ')"><i class="fa fa-trash"></i></a>
              </td>
              <td>
                <a href="../pages/pembayaran/strukPembayaran.php?id=<?php echo $isi[0] ?>" class="btn btn-info btn-info"><i class="fa fa-print"></i></button>
              </td>
            </form>
            </tr>
            <?php } ?>
          ...
          <div class="modal-body">
            ...
            <form method="post">
              <div class="form-group row">
                <label for="" class="form-label col-md-2">Id Pelanggan</label>
                <div class="col-md-10">
